...
const ROUTES: RouteMeta[] = [
  ...
  { match: /^\/admin\/customers$/, title: "People", description: "Customers from web, phone, and the desk" },
  { match: /^\/admin\/inbox$/, title: "Inbox", description: "Web forms and schedule requests" },
